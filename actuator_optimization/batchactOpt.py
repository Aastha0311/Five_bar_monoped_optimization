...
if __name__ == "__main__":
    ...
    if len(sys.argv) not in [4,6]:
        ...
        print("  python actOpt.py <motor> <gearbox_type> <ratio_min> <ratio_max> <step>")
        sys.exit(1)

    motor = sys.argv[1]
    gearbox_type = sys.argv[2]

    # single ratio (original behaviour)
    if len(sys.argv) == 4:
    ...
    # ratio sweep
        ...
        ratio_min = float(sys.argv[3])
        ratio_max = float(sys.argv[4])
