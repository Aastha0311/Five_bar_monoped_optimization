...
class singleStagePlanetaryActuator:
    ...
    def cost(self):
        ...
        cost = 0.33*mass - 0.67 * eff + 0.0 * width
        return cost
...
class compoundPlanetaryActuator:
    ...
    def cost(self):
        ...
        cost = 0.33*massActuator - 0.67 * effActuator + 0.0 * widthActuator
        return cost
...
class optimizationSingleStageActuator:
    ...
    def optimizeActuator(self, Actuator=singleStagePlanetaryActuator, UsePSCasVariable = 1, log = 0, csv = 1, gearRatioReq = 0, printOptParams = 0):
    ...
    def optimizeActuatorWithoutPSC(self, Actuator=singleStagePlanetaryActuator, log=1, csv=0, printOptParams = 0): 
        startTime = time.time()
        opt_parameters = None # [Gear Ratio, numPlanet, Ns, Np, Nr, Module]
        ...
        with open(fileName, "a") as file1:
            ...
            if log:
                ...
                # -------- FIX: print header only if file is new or empty --------
                        ...
                        while 2*Actuator.planetaryGearbox.getPCRadiusPlanetMM() <= Actuator.maxGearboxDiameter/2:
                            ...
                            if 2*Actuator.planetaryGearbox.getPCRadiusRingMM() <= Actuator.maxGearboxDiameter:
                                ...
                                while Actuator.planetaryGearbox.numPlanet <= self.NUM_PLANET_MAX:
                                    ...
                                    if (Actuator.planetaryGearbox.geometricConstraint() and 
                                        ...
                                        if ((Actuator.planetaryGearbox.gearRatio() >= self.gearRatioIter) and
                                            ...
                                            if self.Cost <= MinCost:
                                                ...
                                                opt_parameters = [
                                                    Actuator.planetaryGearbox.gearRatio(),
                                                ...
                                                opt_planetaryGearbox = singleStagePlanetaryGearbox(
                                                ...
                                                opt_actuator = singleStagePlanetaryActuator(
                                                    design_params            = self.design_params,
                                    ...
                                    Actuator.planetaryGearbox.setNumPlanet(
                                        Actuator.planetaryGearbox.numPlanet + 1
                                    )


                            Actuator.planetaryGearbox.setNp(
                                Actuator.planetaryGearbox.Np + 1
                            )


                        Actuator.planetaryGearbox.setNs(
                            Actuator.planetaryGearbox.Ns + 1
                        )


                    Actuator.planetaryGearbox.setModule(
                        Actuator.planetaryGearbox.module + 0.100
                    )
...
class optimizationWolfromPlanetaryActuator:
    ...
    def optimizeActuator(self, Actuator = wolfromPlanetaryActuator, UsePSCasVariable = 1, log = 0, csv = 1, printOptParams=1, gearRatioReq = 0):
        startTime = time.time()
        print("In the optimisation loop", self.K_Mass, self.K_Eff, self.K_Width)
        self.UsePSCasVariable = UsePSCasVariable
        self.gearRatioReq = gearRatioReq
        opt_parameters = None
        if UsePSCasVariable == 0:
    ...
    def optimizeActuatorWithoutPSC(self, Actuator = wolfromPlanetaryActuator, log=1, csv=0, printOptParams = 1):
        ...
        with open(fileName, "a") as wolfromLogFile:
    ...
    def cost(self, Actuator=wolfromPlanetaryActuator):
        ...
        cost = (self.K_Mass    * mass 
                ...
                + self.K_Width * width 
                + K_gearRatio  * gearRatio_err)
        # print(f"Cost Calculation: K_Mass*{mass} + K_Eff*{eff} + K_Width*{width} + K_gearRatio*{gearRatio_err} = {cost}")
        # print(self.K_Mass    * mass)
        # print(self.K_Eff   * eff)
        # print(self.K_Width * width)
        # print(K_gearRatio  * gearRatio_err)
        return cost
...
class optimizationDoubleStagePlanetaryActuator:
    ...
    def optimizeActuatorWithoutPSC(self, Actuator=doubleStagePlanetaryActuator, log=1, csv=0, printOptParams = 1):
        ...
        with open(fileName, "a") as DSPGLogFile:
