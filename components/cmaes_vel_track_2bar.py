...
for coeff_set in coefficient_sets:
    ...
    for seed in seed_list:
        ...
        def get_cost(params):
            ...
            with open(all_samples_file, "a", newline="") as file:
                ...
                writer.writerow([thigh_length,
                    ...
                    total_energy,
                    cost,
                    unique_id] + list(controller_params))
                file.flush()
        ...
        with open(all_samples_file, "a", newline="") as file:
            writer = csv.writer(file)
            writer.writerow(["thigh_length", "calf_length", "motor_hip_name", "motor_knee_name", "gear_hip_ratio", "gear_knee_ratio", "gearbox_hip", "gearbox_knee", "push_duration", "total_tracking_error", "total_energy", "cost", "unique_id"] + [f"ac{i+1}" for i in range(3)])
