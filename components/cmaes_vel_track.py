...
for coeff_set in coefficient_sets:
    ...
    for seed in seed_list:
        ...
        def get_cost(params):
            ...
            target_velocities = [1.5, 3.0, 4.5, 6.0]  # m/s
            velocities = []
            tracking_errors = []
            energies = []
            ...
            for v_target in target_velocities:
                ...
                tracking_error = (actual_vel - v_target)**2
        ...
        "target_v1","actual_v1","tracking_err1","energy1",
        "target_v2","actual_v2","tracking_err2","energy2",
        "target_v3","actual_v3","tracking_err3","energy3",

        "total_tracking_error","total_energy",

        "unique_id"
        ] + [f"ac{i+1}" for i in range(3)])
